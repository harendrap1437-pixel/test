...
DEST_DIR = Path(__file__).resolve().parent.parent / "models" / "translation" / "indictrans2-en-indic-dist-200m"
DEST_DIR.mkdir(parents=True, exist_ok=True)

BASE_URL = "https://huggingface.co/hari31416/indictrans2-en-indic-dist-200M-ONNX-int8/resolve/main/"
...
if __name__ == "__main__":
    print("="*60)
    print("DOWNLOADING OFFICIAL INDICTRANS2 EN-INDIC 200M INT8 ONNX")
    print("Source: https://huggingface.co/hari31416/indictrans2-en-indic-dist-200M-ONNX-int8")
    print("="*60)
    success = True
    for f in FILES:
